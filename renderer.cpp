...
float Renderer::get_scale_from_zground(const unsigned int &z_ground) {
    return 1. - (float)z_ground / (z_ground + cam_dist_to_screen);
}

void Renderer::draw_ground_line(const Level& level, const unsigned int &cam_z_advance, const int &z_ground, const unsigned int &screen_y,
